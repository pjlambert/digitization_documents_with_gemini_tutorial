...
\centering
\textbf{Raw Image}
\includegraphics[width=\textwidth]{assets/image001_raw.jpg}
\end{column}
\begin{column}{0.48\textwidth}
\centering
\textbf{After Preprocessing}
\includegraphics[width=\textwidth]{assets/image001_clean.jpg}
\end{column}
\end{columns}
\vfill
\end{frame}
...
\includegraphics[height=0.55\textheight,keepaspectratio]{assets/annotated_image.jpg}
\end{center}
